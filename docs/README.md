# ZamOps Pool documentation

This folder contains the public, submission-ready explanation of the protocol. It is deliberately separate from `private-notes/`, which is the working project journal.
...
**Operators:** [deployment and operations](deployment-and-operations.md) → [security and limitations](security-and-limitations.md)
